...
if /i "%TARGETATTR:~0,1%" equ "d" if /i "%~n1" neq "" (
cd /d %~1
)
...
set DRILL_FILENAMES=*%~n1.txt *.drd *.xln *.exc *dri.grb *.tap *.drl *anc.drl drl
set TOP_SILK_FILENAMES=*st.pho *.plc *.tsk *silk_top.grb *.sst *.gto *-F_SilkS.g* *-F_Silkscreen.g* *-SilkTop.gbr to
set TOP_PASTE_FILENAMES=*pt.pho *.mmc *.crc *.tsp *.metalmask_top *.spt *.gtp *-F_Paste.g* *-PasteTop.gbr
set TOP_RESIST_FILENAMES=*mt.pho *.stc *.tsm *res_top.grb *.smt *.gts *-F_Mask.g* *-MaskTop.gbr ts
set TOP_PATTERN_FILENAMES=*l1.pho *.cmp *ptn_top.grb *.top *.gtl *-F_Cu.g* *-CuTop.gbr tl
set L2_PATTERN_FILENAMES=*l2.pho *.2l *.ly2 *.gl2 *ptn_sec.grb *.inner1 *.in1 *.g1 *.gp1 *-In1_Cu.g* *-CuIn1.gbr l2
set L3_PATTERN_FILENAMES=*l3.pho *.3l *.ly3 *.l15 *.gl3 *ptn_thi.grb *.inner2 *.in2 *.g2 *.gp2 *-In2_Cu.g* *-CuIn2.gbr l3
set BOT_PATTERN_FILENAMES=*l4.pho *.sol *ptn_btm.grb *.bot *.gbl *-B_Cu.g* *-CuBottom.gbr bl
set BOT_RESIST_FILENAMES=*mb.pho *.sts *.bsm *res_btm.grb *.smb *.gbs *-B_Mask.g* *-MaskBottom.gbr bs
set BOT_PASTE_FILENAMES=*pb.pho *.mms *.crs *.bsp *.metalmask_bot *.spb *.gbp *-B_Paste.g* *-PasteBottom.gbr
set BOT_SILK_FILENAMES=*sb.pho *.pls *.bsk *slk_btm.grb *.ssb *.gbo *-B_SilkS.g* *-B_Silkscreen.g* *-SilkBottom.gbr bo
set BOARD_OUTLINE_FILENAMES=*.out *.dim *.gm3 *.gml *outline.grb *.gko *.fab *.gm1 *-Edge_Cuts.g* *EdgeCuts.gbr ko
...
set DRILL_COLOR=5911 5898 5911
set TOP_SILK_COLOR=54965 54965 54965
set TOP_PASTE_COLOR=31761 31611 31785
set TOP_RESIST_COLOR=64431 65535 0
set TOP_PATTERN_COLOR=0 37355 0
set L2_PATTERN_COLOR=65021 23947 13107
set L3_PATTERN_COLOR=30451 0 65535
set BOT_PATTERN_COLOR=0 28139 65535
set BOT_RESIST_COLOR=58363 58536 46748
...
set TOP_SILK_ALPHA=45489
set TOP_PASTE_ALPHA=45489
set TOP_RESIST_ALPHA=43176
set TOP_PATTERN_ALPHA=40092
set L2_PATTERN_ALPHA=22873
set L3_PATTERN_ALPHA=22873
set BOT_PATTERN_ALPHA=36494
...
@rem END
echo.
if exist "%CD%\%GVPFILE%" echo:Gerbv project file was created: "%CD%\%GVPFILE%".
